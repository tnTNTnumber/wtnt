...
function _GeneratorClock_ClockDraw_fe() { /*Generator Clock /Clock Draw*/
	...
	if(0<=_GeneratorClock_D_H_ve&&_GeneratorClock_D_H_ve<6) {
		_GeneratorClock_D1_ve.style.left = 'calc('+_GeneratorClock_WW_ve+'px - '+_GeneratorClock_RS_se+' - '+_GeneratorClock_RM_se+')';
		_GeneratorClock_D1_ve.style.transform = 'rotate(40deg)';
	} else if(6<=_GeneratorClock_D_H_ve&&_GeneratorClock_D_H_ve<12) {
		_GeneratorClock_D1_ve.style.left = _GeneratorClock_RM_se;
		_GeneratorClock_D1_ve.style.transform = 'rotate(0deg)';
	} else if(12<=_GeneratorClock_D_H_ve&&_GeneratorClock_D_H_ve<18) {
		_GeneratorClock_D1_ve.style.left = 'calc('+_GeneratorClock_WW_ve+'px - 2*'+_GeneratorClock_RS_se+' - 2*'+_GeneratorClock_RM_se+')';
		_GeneratorClock_D1_ve.style.transform = 'rotate(0deg)';
